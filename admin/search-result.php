...
<?php
$title = "Search Results | Hungry Paws";

include $_SERVER['DOCUMENT_ROOT'] . '/HungryPaws/includes/head.php';
?>
...
<body>
                    ...
                    <div class="search-toolbar">
                        <ul class="list-unstyled nav nav-tabs nav-pills">
                            <li class="nav-item active">
                                <a class="nav-link" data-bs-target="#everything" data-bs-toggle="tab">Everything</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-target="#medias" data-bs-toggle="tab">Medias</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <a href="pages-user-profile.html" class="has-thumb">
                                        ...
                                        <div class="result-data">
                                            ...
                                            <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit. Donec ante nisl, sagittis nec lacus et, convallis efficitur justo.
                                                Curabitur elementum feugiat quam. Etiam ac orci iaculis, luctus nisl et,
                                                aliquet metus. Praesent congue tortor venenatis, ornare eros eu, semper
                                                orci.</p>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    ...
                                    <a href="ui-elements-charts.html">
                                        <div class="result-data">
                                            ...
                                            <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit. Donec ante nisl, sagittis nec lacus et, convallis efficitur justo.
                                                Curabitur <strong>something</strong> elementum feugiat quam. Etiam ac
                                                orci iaculis, luctus nisl et, aliquet metus. Praesent congue tortor
                                                venenatis, ornare eros eu, semper orci.</p>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <a href="mailbox-email.html" class="has-thumb">
                                        ...
                                        <div class="result-data">
                                            <p class="h3 title text-primary">John Doe</p>
                                            <p class="description">
                                                <small>05/09/2023 11:34PM</small>
                                                <br />
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ante
                                                nisl, sagittis nec lacus et, convallis efficitur justo. Curabitur
                                                elementum feugiat quam. Etiam ac orci iaculis, luctus nisl et, aliquet
                                                metus. Praesent congue tortor venenatis, ornare eros eu, semper orci.
                                            </p>
                                        </div>
                                    </a>
                                </li>
    ...
    <?php
    include $_SERVER['DOCUMENT_ROOT'] . '/HungryPaws/includes/script.php';
    ?>
