                                            ...
                                            <?php if (!empty($users)): ?>
                                                <?php foreach ($users as $user): ?>
                                                    <tr>
                                                        ...
                                                        <td><strong><?= htmlspecialchars($user['user_id']) ?></strong>
                                                        </td>
                                                        <td><strong><?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?></strong></a>
                                                        </td>
                                                        ...
                                                        <td><span
                                                                class="<?= getStatusClass($user['status']) ?>"><?= getStatusText($user['status']) ?></span>
                                                        </td>
