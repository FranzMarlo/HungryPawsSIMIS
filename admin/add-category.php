...
<body>
        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modernmt-0">
                <header class="page-header page-header-left-inline-breadcrumb">
                    <h2 class="font-weight-bold text-6">Add Product Category</h2>
                </header>

                <!-- start: page -->
                <form class="ecommerce-form action-buttons-fixed" method="post" id="addCategoryForm">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row action-buttons">
                        <div class="col-12 col-md-auto">
                            <button type="submit"
                                ...
                                <i class="bx bx-save text-4 me-2"></i> Add Category
                            </button>
                        </div>
    ...
    <script src="/HungryPaws/assets/js/admin/add-category.js"></script>
