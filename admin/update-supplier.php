...
<?php
$title = "Update Supplier | Hungry Paws";

include $_SERVER['DOCUMENT_ROOT'] . '/HungryPaws/includes/admin/admin-head.php';
$fetch = new fetchClass();
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $supplierID = $_GET['id'];
    $supplierDetails = $fetch->getSupplierDetails($supplierID);
} else {
    header("Location: /HungryPaws/admin/suppliers");
}
?>
...
<body>
        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modernmt-0">
                <header class="page-header page-header-left-inline-breadcrumb">
                    <h2 class="font-weight-bold text-6">Update Supplier</h2>
                </header>

                <!-- start: page -->
                <form class="ecommerce-form action-buttons-fixed" method="post" id="updateSupplierForm">
                    <div class="row">
                        <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-2-5 col-xl-1-5">
                                            ...
                                            <h2 class="card-big-info-title">Supplier Info</h2>
                                            <p class="card-big-info-desc">Add here the supplier details such as supplier
                                                name, contact person and his/her email and phone.</p>
                                        </div>
                                        <div class="col-lg-3-5 col-xl-4-5">
                                            <div class="form-group row align-items-center pb-3">
                                                <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Supplier
                                                    Name</label>
                                                <div class="col-lg-7 col-xl-6">
                                                    <input type="text" class="form-control form-control-modern"
                                                        name="supplierName" id="supplierName"
                                                        placeholder="<?= htmlspecialchars($supplierDetails['supplier_name']) ?>"
                                                        value="<?= htmlspecialchars($supplierDetails['supplier_name']) ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group row align-items-center pb-3">
                                                ...
                                                <div class="col-lg-7 col-xl-6">
                                                    <input type="text" class="form-control form-control-modern"
                                                        ...
                                                        placeholder="<?= htmlspecialchars($supplierDetails['contact_person']) ?>"
                                                        value="<?= htmlspecialchars($supplierDetails['contact_person']) ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group row align-items-center pb-3">
                                                <label
                                                ...
                                                <div class="col-lg-7 col-xl-6">
                                                    <input type="text" class="form-control form-control-modern"
                                                        name="email" id="email"
                                                        placeholder="<?= htmlspecialchars($supplierDetails['email']) ?>"
                                            ...
                                            <div class="form-group row align-items-center pb-3">
                                                ...
                                                <div class="col-lg-7 col-xl-6">
                                                    <input type="text" class="form-control form-control-modern"
                                                        name="phone" id="phone"
                                                        placeholder="<?= htmlspecialchars($supplierDetails['phone']) ?>"
                                                        value="<?= htmlspecialchars($supplierDetails['phone']) ?>"
                                                        maxlength="13" />
                                                </div>
                                            </div>
                                            <input type="hidden" name="supplierId" value="<?= htmlspecialchars($supplierID) ?>">
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div class="row action-buttons">
                        <div class="col-12 col-md-auto">
                            <button type="submit"
                                ...
                                <i class="bx bx-save text-4 me-2"></i> Update Supplier
                            </button>
                        </div>
    ...
    <script src="/HungryPaws/assets/js/admin/update-supplier.js"></script>
