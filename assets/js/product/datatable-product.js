(function ($) {
  ...
  var ecommerceListDataTableInit = function () {
    var $ecommerceListTable = $("#datatable-product-list");
    ...
    $ecommerceListTable.dataTable({
      ...
      drawCallback: function () {
        ...
        $ecommerceListTable
          ...
          .find(".pagination")
          .addClass(
            "pagination-modern pagination-modern-spacing justify-content-center"
          );
      },
    });
    ...
    $ecommerceListTable.find(".select-all").on("change", function () {
      if (this.checked) {
        $ecommerceListTable
          .find('input[type="checkbox"]:not(.select-all)')
          .prop("checked", true);
      } else {
        $ecommerceListTable
          .find('input[type="checkbox"]:not(.select-all)')
