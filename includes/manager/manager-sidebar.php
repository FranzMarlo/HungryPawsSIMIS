        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main">
                    ...
                    <li class="<?= ($current_page == 'products.php' || $current_page == 'product-report.php') ? 'nav-active' : '' ?>">
                        <a class="nav-link" href="products">
                            <i class="fa-solid fa-coins" aria-hidden="true"></i>
                            <span>Products</span>
                        </a>
                    </li>
                    <li class="<?= ($current_page == 'orders.php' || $current_page == 'receipt.php' || $current_page == 'order-report.php') ? 'nav-active' : '' ?>">
                        <a class="nav-link" href="orders">
                            <i class="fa-solid fa-scroll" aria-hidden="true"></i>
                            <span>Orders</span>
                        </a>
                    </li>
                    <li class="<?= ($current_page == 'transfers.php' || $current_page == 'update-request.php' || $current_page == 'transfer-report.php') ? 'nav-active' : '' ?>">
                    ...
                    <li class="<?= ($current_page == 'pet-grooming.php' || $current_page == 'grooming-report.php') ? 'nav-active' : '' ?>">
                        <a class="nav-link" href="pet-grooming">
                            <i class="fa-solid fa-shower" aria-hidden="true"></i>
                            <span>Pet Grooming Records</span>
                        </a>
                    </li>
                    <li class="<?= ($current_page == 'pet-hotel.php' || $current_page == 'hotel-report.php') ? 'nav-active' : '' ?>">
