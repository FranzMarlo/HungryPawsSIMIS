...
<script src="/HungryPaws/assets/js/examples/examples.modals.js"></script>

<script src="/HungryPaws/assets/js/togglePassword.js"></script>
<script src="/HungryPaws/assets/js/login.js"></script>