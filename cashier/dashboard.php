        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modern">
                <header class="page-header page-header-left-inline-breadcrumb">
                    <h2 class="font-weight-bold text-6">Cashier Dashboard</h2>
                </header>
                                        ...
                                        <div class="widget-user-info">
                                            ...
                                            <div class="widget-user-info-body">
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <strong
                                                            class="text-color-dark text-5"><?= htmlspecialchars($saleStats['total_orders']) ?></strong>
                                                        <h3 class="text-4-1">Orders Processed</h3>
                                                    </div>
                                                    <div class="col-auto">
                                                        <strong
                                                            class="text-color-dark text-5"><?= htmlspecialchars('₱' . $saleStats['total_amount']) ?></strong>
                                                        <h3 class="text-4-1">Amount Processed</h3>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
