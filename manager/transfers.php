...
$requests = $fetch->getManagerStockRequests($branch_id);
?>
        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modern mt-0">
                <header class="page-header page-header-left-inline-breadcrumb">
                    <h2 class="font-weight-bold text-6">Stock Transfer Requests</h2>
                </header>
                                        ...
                                        <tbody>
                                            <?php if (!empty($requests)): ?>
                                                <?php foreach ($requests as $request): ?>
                                                    <tr>
                                                        <td><strong><?= htmlspecialchars($request['transfer_id']) ?></strong>
                                                        </td>
                                                        <td><strong><?= htmlspecialchars($request['product_name']) ?></strong>
                                                        </td>
