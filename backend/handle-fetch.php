...
switch ($submitType) {
    ...
    case 'getGlobalMonthlyRevenue':
        $branchId = $_POST['branchId'] ?? '';
        $response = $fetchClass->getGlobalMonthlyRevenue();
        break;
    ...
    case 'generateInventoryStatusReport':
        ...
        if (empty($branch_id)) {
            ...
            $response = $fetchClass->getGlobalInventoryStatusReport($startDate, $endDate, $filterType);
            echo json_encode($response);
            exit;
        } else {
    ...
    case 'generateGroomingReport':
        ...
        if (empty($branchId)) {
            ...
            $groomingList = $fetchClass->getGlobalGroomingReport($startDate, $endDate);
            $groomingCount = $fetchClass->getGlobalGroomingCount($startDate, $endDate);
            $petCount = $fetchClass->getGlobalGroomingPetCount($startDate, $endDate);
    ...
    case 'generateBookingReport':
        ...
        if (empty($branchId)) {
            ...
            $bookingList = $fetchClass->getGlobalBookingReport($startDate, $endDate);
            $bookingCount = $fetchClass->getGlobalBookingCount($startDate, $endDate);
            $petCount = $fetchClass->getGlobalBookingPetCount($startDate, $endDate);
